...
trees <- c('RAxML_bestTree.vipr_lam_T5',
      	 'RAxML_bestTree.dcr_all_2014_tree')


lsd_cmd <- '/Applications/phylo_apps/lsd-0.3beta-master/bin/lsd_mac -i INTREE -d INDATE -f 100 -c -s 1000 -r a'

# change
# /Applications/phylo_apps/lsd-0.3beta-master/bin/lsd_mac
# to the directory in your machine
